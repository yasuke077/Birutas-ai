...
const icons = {
    coin: await loadImage(path.join(__dirname, 'emojis', 'coin.png')),
    star: await loadImage(path.join(__dirname, 'emojis', 'star.png')),
    ring: await loadImage(path.join(__dirname, 'emojis', 'ring.png'))
};
