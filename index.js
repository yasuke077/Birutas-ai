...
/* ─────────────────────────────────────────────── */
try {
    // 1ª opção: fonte embutida no projeto (mais confiável em qualquer servidor)
    ...
    try {
        // 2ª opção: fontes do sistema (Railway/Debian com fonts-dejavu-core)
        ...
        console.log('✅ Fontes DejaVu do sistema carregadas.');
    } catch (e2) {
...
async function getData(guildId, userId = null) {
    try {
        ...
        // DEFAULT_IAS sempre prevalece sobre valores antigos do banco para IAs built-in
    ...
    try {
        ...
        if (commandName === 'profile') {
            ...
            try {
                ...
                // 2. BACKGROUND (gradiente local — Imgur bloqueia requisições de servidor)
                ...
                // Linha decorativa na cor do perfil
