...
// ============================
        ...
        if (commandName === 'profile') {
            ...
            // --- CORREÇÃO DE FONTES ABAIXO ---
            
            ctx.fillStyle = '#ffffff';
            // Usamos "DejaVu Sans" entre aspas, que é a fonte padrão do Railway/Linux
            ...
            ctx.font = 'italic 22px "DejaVu Sans"';
            ...
            td.badges.slice(0, 10).forEach((badgeId) => {
                ...
                if (bInfo) {
                    // Para emojis, "serif" costuma ter melhor suporte a símbolos no Linux
                    ctx.font = '35px "DejaVu Serif", serif'; 
